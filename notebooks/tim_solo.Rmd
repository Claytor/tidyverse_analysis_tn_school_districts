...
#7.  Create a histogram showing the distribution of graduation rates.
    ...
    # The majority of the school districts seem to have graduation rates 
    between  
...
#8.  Create a scatter plot to compare alg_1 proficiency rates to alg_2
    ...
    # for most regions, algebra 1 scores are positively 
...
```{r}
WeightedGrad <- districts %>% 
  group_by(enrollment) %>% 
  summarize(avg_grad = weighted.mean(grad, enrollment, na.rm = FALSE))
mean(WeightedGrad$avg_grad, na.rm = TRUE)
```
